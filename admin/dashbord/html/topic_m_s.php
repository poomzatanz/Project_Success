...
<div id="wrapper">
  ...
  $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'positive' and SUBSTRING(time, 7, 2) = '".$get_id."' and topic LIKE '%".$search."%'  GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";
    ...
    if ($result->num_rows > 0) {
        ...
        $totol[] = "\"".$o1."\","."\"".$o2."\","."\"".$o3."\","."\"".$o4."\","."\"".$o5."\","."\"".$o6."\","."\"".$o7."\","."\"".$o8."\","."\"".$o9."\","."\"".$o10."\","."\"".$o11."\","."\"".$o12."\"";
    
    }

    $sql = "SELECT count(*) as num  FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' and topic LIKE '%".$search."%' ;";
    $result = $conn->query($sql);
   // echo $sql;
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'negative' and SUBSTRING(time, 7, 2) = '".$get_id."'  and topic LIKE '%".$search."%'  GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
  // echo $sql;
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    if ($result->num_rows > 0) {
        ...
        $totol1[] = "\"".$n1."\","."\"".$n2."\","."\"".$n3."\","."\"".$n4."\","."\"".$n5."\","."\"".$n6."\","."\"".$n7."\","."\"".$n8."\","."\"".$n9."\","."\"".$n10."\","."\"".$n11."\","."\"".$n12."\"";
    
    }
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'normal' and SUBSTRING(time, 7, 2) = '".$get_id."' and topic LIKE '%".$search."%'   GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
  //  echo $sql;
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    ELSE 'err'
    END AS month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' and topic LIKE '%".$search."%'   GROUP BY topic_acc;";  
...
//echo $totol1.'<br>';
    ...
    <div class="row" >
        <div class="c">
            ...
            <form class="form-inline" action="topic_m_s.php" method="get">
	...
	<!-- start slider -->
	<div class="container">
    <form class="form-inline" action="topic_s.php" method="get">
							<div class="input-group input-group-md">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="topic_s.php?name=<?php echo $search?>">กลับ</a></li>
                            <div class="ml-auto">
