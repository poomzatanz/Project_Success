...
<div id="wrapper">
 ...
 $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web WHERE text_a = 'positive' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";
    ...
    $sql = "SELECT count(*) as num  FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web WHERE SUBSTRING(time, 7, 2) = '".$get_id."';";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web WHERE text_a = 'negative' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web WHERE text_a = 'normal' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    ELSE 'err'
    END AS month FROM  web INNER JOIN coment1 ON web.pk_web = coment1.pk_web WHERE SUBSTRING(time, 7, 2) = '".$get_id."'  GROUP BY text_a";  
 ...
 $mou = implode(",", $mou);
    ...
    <div class="row" >
        <div class="c">
            ...
            <form class="form-inline" action="coment_m.php" method="get">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h2 data-shadow='dang!'>ความคิดเห็น <?php echo "ของปี พ.ศ.".$get_id." มีจำนวนทั้งหมด <br>".$p." ความคิดเห็น"?> </h2>
