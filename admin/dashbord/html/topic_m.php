...
<div id="wrapper">
 ...
 $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'positive' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";
    ...
    $sql = "SELECT count(*) as num  FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."';";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'negative' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE topic_acc = 'normal' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    //$sql = " SELECT count(*) as num ,topic_acc as month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY topic_acc;";         
    ...
    ELSE 'err'
    END AS month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY topic_acc;";  
 ...
 $mou = implode(",", $mou);
    ...
    <div class="row" >
        <div class="c">
            ...
            <form class="form-inline" action="topic_m.php" method="get">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h2 data-shadow='dang!'>หัวข้อกระทู้ <?php echo "ของปี พ.ศ.".$get_id." มีจำนวนทั้งหมด ".$p." กระทู้"?> </h2>
