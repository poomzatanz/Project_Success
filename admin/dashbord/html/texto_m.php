...
<div id="wrapper">
  ...
  $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'positive' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'negative' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'normal' and SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
   ...
   // $sql = " SELECT count(*) as num ,text_acc as month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' GROUP BY text_acc;";         
    ...
    ELSE 'err'
    END AS month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."'  GROUP BY text_acc;";  
 ...
 $mou = implode(",", $mou);
    ...
    <div class="row" >
        <div class="c">
            ...
            <form class="form-inline" action="texto_m.php" method="get">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h2 data-shadow='dang!'>เนื้อหากระทู้ <?php echo "ของปี พ.ศ.".$get_id." มีจำนวนทั้งหมด ".$p." เนื้อหา"?> </h2>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="texto.php">กลับ</a></li>
                            <div class="ml-auto">
