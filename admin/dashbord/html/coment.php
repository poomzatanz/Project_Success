...
<div id="wrapper">
 ...
 $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month  FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web  WHERE coment1.text_a = 'positive' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month  FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web  WHERE coment1.text_a = 'negative' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month  FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web  WHERE coment1.text_a = 'normal' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    ...
    $sql = "SELECT count(*) as num ,text_a as month  FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web GROUP BY text_a;";  
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h1 data-shadow='dang!'>ความคิดเห็น</h1>
                                <h1 data-shadow='dang!'>แสดงข้อมูลในแต่ละปี</h1>
                                <?php //echo $lable1; ?>
                            </div>
                            <div class="ml-auto">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="acc_group.php">ดูประสิทธิภาพ</a></li>
                            <div class="ml-auto">
...
options: {
  ...
  var reY = startY+y;
  window.location="coment_m.php?id="+reY;
