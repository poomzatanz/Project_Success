...
<div id="wrapper">
	...
	$sql = "SELECT AVG(group_acc)*100  as num ,web.group as month FROM web  GROUP BY web.group ORDER by web.group";
    ...
    $sql = "SELECT AVG(group_acc) as num ,web.group as month FROM web GROUP BY web.group;";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h1 data-shadow='dang!'>ค่าความถูกต้องในการจัดกลุ่ม</h1>
                                <?php //echo $lable1; ?>
                            </div>
                            <div class="ml-auto">
...
data: {
 ...
 datasets: [ 
    { 
        data: [<?php echo $totol; ?>],
        label: "ค่าความถูกต้องในการจัดกลุ่ม",
 ...
 datasets: [ 
		 {
             ...
             backgroundColor: ["#3e95cd","#23E31D","#FA6103","#e8c3b9", "#8e5ea2","#EC4653"]
