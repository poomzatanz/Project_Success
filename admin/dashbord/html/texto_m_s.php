...
<div id="wrapper">
 ...
 $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'positive' and SUBSTRING(time, 7, 2) = '".$get_id."' and texto LIKE '%".$search."%'  GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";
    ...
    $sql = "SELECT count(*) as num  FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' and texto LIKE '%".$search."%' ;";
    $result = $conn->query($sql);
   // echo $sql;
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'negative' and SUBSTRING(time, 7, 2) = '".$get_id."'  and texto LIKE '%".$search."%'  GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 4, 2) as month FROM web WHERE text_acc = 'normal' and SUBSTRING(time, 7, 2) = '".$get_id."' and texto LIKE '%".$search."%'   GROUP BY SUBSTRING(time, 4, 2) ORDER by SUBSTRING(time, 4, 2);";         
  //  echo $sql;
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    CASE 
    WHEN text_acc = 'normal' THEN 'ปกติ'
    WHEN text_acc = 'negative' THEN 'แง่ลบ'
    WHEN text_acc = 'positive' THEN 'แง่บวก'
    ELSE 'err'
    END AS month FROM web WHERE SUBSTRING(time, 7, 2) = '".$get_id."' and texto LIKE '%".$search."%'   GROUP BY text_acc;";  
...
//echo $totol1.'<br>';
    ...
    <div class="row" >
        <div class="c">
            ...
            <form class="form-inline" action="texto_m_s.php" method="get">
	...
	<!-- start slider -->
	<div class="container">
    <form class="form-inline" action="texto_s.php" method="get">
							<div class="input-group input-group-md">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="texto_s.php?name=<?php echo $search?>">กลับ</a></li>
                            <div class="ml-auto">
