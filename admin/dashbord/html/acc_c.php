...
<div id="wrapper">
	...
	$sql = "SELECT AVG(pre_coment.text_r)  as num ,pre_coment.text_a as month FROM pre_web INNER JOIN pre_coment ON pre_web.pk_web = pre_coment.pk_web WHERE pre_coment.text_a IS NOT NULL GROUP BY pre_coment.text_a ORDER by pre_coment.text_a";
    ...
    $sql = "SELECT AVG(pre_coment.text_r)/100 as num ,pre_coment.text_a as month FROM pre_web INNER JOIN pre_coment ON pre_web.pk_web = pre_coment.pk_web WHERE pre_coment.text_a IS NOT NULL GROUP BY pre_coment.text_a ORDER by pre_coment.text_a";
    $result = $conn->query($sql);
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h1 data-shadow='dang!'>ค่าความถูกต้องในการวิเคราะห์ความคิดเห็น</h1>
                                <?php //echo $lable1; ?>
                            </div>
                            <div class="ml-auto">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="comment.php">กลับ</a></li>
                            <div class="ml-auto">
...
type: 'bar',
data: {
 labels: ["ความรู้สึกแง่ลบ","ความรู้สึกปกติ","ความรู้สึกแง่บวก"],
 datasets: [ 
    { 
        data: [<?php echo $totol; ?>],
        label: "ค่าความถูกต้องในการวิเคราะห์ความรู้สึกเนื้อหากระทู้",
 ...
 datasets: [ 
		 {
             ...
             borderColor: ["#FA6103","#3e95cd","#23E31D","#e8c3b9", "#8e5ea2"],
