...
<div id="wrapper">
 ...
 $conn = new mysqli("db4free.net","poomzaadekd2023","poomzaadekd2023","dekdanalatic2023");
	...
	$sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month FROM web WHERE text_acc = 'positive' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month FROM web WHERE text_acc = 'negative' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = "SELECT count(*) as num ,SUBSTRING(time, 7, 2) as month FROM web WHERE text_acc = 'normal' GROUP BY SUBSTRING(time, 7, 2) ORDER by SUBSTRING(time, 7, 2);";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
    ...
    $sql = " SELECT count(*) as num ,text_acc as month FROM web  GROUP BY text_acc;";  
    // echo    $sql;      
    $totolc = array();
    $mou = array();
     $result = $conn->query($sql);
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h1 data-shadow='dang!'>เนื้อหากระทู้</h1>
...
options: {
  ...
  var reY = startY+y;
  window.location="texto_m.php?id="+reY;
