...
<div id="wrapper">
	...
	<header>
      ...
      <?php
					...
					<td>  <div class="form-row p-t-20">
                            ...
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">นักศึกษา
                                    <input type="radio"  name="status_name" value="นักศึกษา>"
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container m-r-55">อาจารย์
                                    <input type="radio" name="status_name" value="อาจารย์">
                                    <span class="checkmark"></span>
                                </label>
								<label class="radio-container m-r-55">บุคคลภายนอก
                                    <input type="radio" name="status_name" value="บุคคลภายนอก" >
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
        ...
        <tr>
					...
					<td><input type="text" name="login_status" value=""></td>
				</tr>		
				</tr>
			</tbody>
		</table>
	...
	<div class="container">
		...
		<button class="login100-form-btn" onClick="this.form.action='process_reg.php'; submit()">
      ตกลง
			</button>
