...
<?php
	...
	$sql = "SELECT web.pk_web, topic, count(*) FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web  where coment1.text_a = 'positive' GROUP BY web.pk_web ORDER BY count(*) DESC LIMIT 10";
