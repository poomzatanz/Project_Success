...
<div id="wrapper">
	...
	<header>
      ...
      $get_id = isset($_GET['id']) ? $_GET['id'] : 0;
					 $str = "select useid,password,first_name,last_name,email,phone,name_status,login_status from user where pk_user = ".$get_id;
					$result = mysqli_query($db,$str);
					$row = mysqli_fetch_array($result,MYSQLI_ASSOC);
					
					
          ?>
           <input type="hidden" id="custId" name="custId" value=<?php echo $get_id; ?>>
				<tr>
					<td align="center" > ชื่อเข้าใช้งาน </td>				
					<td><input type="text" name="userid" value =<?php echo $row['useid']; ?>> </td>
				</tr>
        <tr>
					<td align="center" > รหัสเข้าใช้งาน</td>				
					<td><input type="password" name="pass" value =<?php echo $row['password']; ?>></td>
				</tr>
        <tr>
					<td align="center" > ชื่อ </td>				
					<td><input type="text" name="first" value =<?php echo $row['first_name']; ?> ></td>
				</tr>
        <tr>
					<td align="center" > นามสกุล</td>				
					<td><input type="text" name="last" value =<?php echo $row['last_name']; ?>></td>
				</tr>
        <tr>
        ...
        <tr>
					...
					<td>  <div class="form-row p-t-20">
                        
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">นักศึกษา
                                    <input type="radio"  name="status_name" value="นักศึกษา" <? if($row["name_status"]=="นักศึกษา"){ print "checked";}; ?>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container m-r-55">อาจารย์
                                    <input type="radio" name="status_name" value="อาจารย์" <? if($row["name_status"]=="อาจารย์"){ print "checked";}; ?>
                                    <span class="checkmark"></span>
                                </label>
								<label class="radio-container m-r-55">บุคคลภายนอก
                                    <input type="radio" name="status_name" value="บุคคลภายนอก" <? if($row["name_status"]=="บุคคลภายนอก"){ print "checked";}; ?>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
        ...
        <tr>
					<td align="center" > สถานะการใช้งาน</td>				
					<td><input type="text" name="login_status" value =<?php echo $row['login_status']; ?>></td>
				</tr>		
				</tr>
			</tbody>
		</table>
	...
	<div class="container">
		...
		<button class="login100-form-btn" onClick="this.form.action='process_edit.php'; submit()">
      ตกลง
			</button>
